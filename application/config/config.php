...
{
	case 'development':
		$config['base_url']	= 'http://duffymba.local:5757/';
	break;
	...
	case 'production':
		$config['base_url']	= 'http://analytics.cafeduff.com/';
	break;
...
|
*/
$config['encryption_key'] = '5wH4YKcSZJKbZlfRoiZbSwHl07RxjrxtW5G50jtXzrUshn87ssttphz7P6s8DtJ';
...
$config['sess_cookie_name']		= 'analytics_app_session';
