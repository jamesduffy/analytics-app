...
class AppDotNet {
	...
	public function __construct() {
		$this->_clientId = 'tspP2NYqMtzb92faRNn2pbWMWk6cDSZ3';
		$this->_clientSecret = 'hGjkxJGEDQ9jhxQeD4HNb2as8h83rNR8';
  ...
  public function checkScopes($app_scopes) {
	 ...
	 * @param array $params An associative array of general parameters.
	 * This will likely change as the API evolves, as of this writing allowed keys
	 * are: include_annotations.
	 * @return array An associative array representing the post
	 */
	public function getPosts($params = array()) {
		return $this->httpReq('get',$this->_baseUrl.'posts?'.$this->buildQueryString($params));
	}
	...
	/**
	 * Return Posts matching a specific query.
