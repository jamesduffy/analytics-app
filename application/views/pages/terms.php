<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?php $this->load->view('pages/sidebar', array('current_page' => 'terms')); ?>
        </div>

        <div class="col-md-8">
            <div class="inner box">
                <h2>Terms of Service</h2>
                <h3 class="muted">Last Updated April 2, 2014</h3>

                <strong>Accepting these Terms</strong>

                <p>If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing hello at jamesduffy dot me.</p>
                ...
                <p>Whenever we make changes to these Terms, the changes are effective 30 days after we post such revised Terms (indicated by revising the date at the top of these Terms) or upon your acceptance if we provide a mechanism for your immediate acceptance of the revised Terms (such as a click-through confirmation or acceptance button). It is your responsibility to check for changes to these Terms.</p>
                ...
                <p>For information about how we collect and use information about users of the Service, please check out our privacy policy available at <?=anchor('pages/privacy')?>.</p>
                ...
                <strong>Creating Accounts</strong>
           ...
           <p>Our service is intended for accounts that are directly controlled by a human. Accounts that appear to be a bot or feed will not have their posts tracked by our service. We are looking into increasing transparency for those who may be blocked incorrectly.</p>

                <p>Our Service allows you and other users to view analytics data about App.net user's profiles and posts. You are responsible for the content that you make available to the Service, including its legality, reliability, and appropriateness.</p>

                <p>When you post, link or otherwise make available content to the Service through posting to App.net, you grant us the right and license to use, reproduce, modify, publicly perform, publicly display and distribute your content on or through the Service. We may format your content for display throughout the Service, but we will not edit or revise the substance of your content itself.</p>
                ...
                <p>You can remove the content that you posted by deleting it on App.net. Once you delete your content, it will not appear on the Service, but copies of your deleted content may remain in our system or backups for some period of time. We will retain web server access logs for a maximum of one year and then delete them.</p>

                <p>To remove yourself permentely from the Service email hello at jamesduffy dot me with the subject "Analytics Opt-Out" with your username or user ID in the body. Your data will be removed from the server within 7-10 buisness days and collection of your future posts will stop.</p>
                ...
                <strong>Analytics-App Materials</strong>
                ...
                <strong>Hyperlinks and Third Party Content</strong>
                ...
                <p>James Duffy makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.</p>
                ...
                <strong>Unavoidable Legal Stuff</strong>
                ...
                <p>IN NO EVENT WILL JASON FAMULARO BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO JASON FAMULARO. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.</p>
                ...
                <p>These Terms constitute the entire agreement between you and James Duffy regarding the use of the Service, superseding any prior agreements between you and James Duffy relating to your use of the Service.</p>

                <p>Any portion of this agreement found to be invalid in the State of California does not any other portion of the agreement invalid.</p>

                <strong>Feedback</strong>

                <p>Please let us know what you think of the Service, these Terms and, in general, Analytics-App. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, Analytics-App, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.</p>

                <strong>Questions & Contact Information</strong>

                <p>Questions or comments about the Service may be directed to us at the email address james at cafeduff dot com</p>
